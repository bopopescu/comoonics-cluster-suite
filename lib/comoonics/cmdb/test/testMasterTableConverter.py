...
from comoonics.cmdb.Converter import TableMainConverter
...
class Test(unittest.TestCase):
    ...
    def testconvertcolnames(self):
        self.converter=TableMainConverter(self.differences, "lilr601")
        self.converter.convert()
        rows=self.converter.columnnames
        expectedresult=['source: name', 'name', 'architecture', 'main: version', 'main: subversion', 'source: version', 'source: subversion']
